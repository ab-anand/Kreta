...
def basicScanner():
    ...
    try:
        ...
        try:
            ...
            fileStatusJson = scanner.cleanDirectory(inputPath, outputPath=outputPath)
...
def intelligentScanner():
    ...
    try:
        ...
        try:
            ...
            fileStatusJson = scanner.cleanDirectory(inputPath, depth=depth, outputPath=outputPath)
            fileStatus = json.loads(fileStatusJson)
            printAppBanner()
